import BarMeta from '/Users/haloworld/Project/lowcode-antv-materials/lowcode/bar/meta'
...
import MagneticContainerMeta from '/Users/haloworld/Project/lowcode-antv-materials/lowcode/magnetic-container/meta'
...
function fillRealVersion(meta, packageName = '@seada/antv-materials', version = '0.1.0', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
const componentMetas = [BarMeta,ColumnMeta,LineMeta,MagneticContainerMeta,PieMeta];
const components = [];
const npmInfo = {};
